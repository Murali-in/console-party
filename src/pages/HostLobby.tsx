...
const BUILT_IN_GAMES = [
  { id: 'apex-arena', title: 'Apex Arena', genre: 'Shooter', minPlayers: 2, maxPlayers: 4, desc: 'Top-down arena shooter with shields, dashes, and tactical combat. First to 10 kills wins.', coverClass: 'cover-apex-arena', type: 'phaser' },
  { id: 'pong', title: 'Pong', genre: 'Classic', minPlayers: 2, maxPlayers: 2, desc: 'Classic 2-player pong with paddle spins and speed ramps. First to 7 points wins.', coverClass: 'cover-pong', type: 'phaser' },
  { id: 'maze-runner', title: 'Maze Runner', genre: 'Puzzle', minPlayers: 2, maxPlayers: 4, desc: 'Race through procedural mazes, collect coins, dodge traps, and find the exit first.', coverClass: 'cover-maze-runner', type: 'phaser' },
];
